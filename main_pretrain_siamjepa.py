...
# This file is based on the MAE implementation by Meta Platforms
# and has been substantially modified for SiamJEPA.
#
# Original project:
# https://github.com/facebookresearch/mae
#
# Modifications include:
# - Siamese student encoder
# - JEPA-style predictive objective
# - KL regularization
# - Training pipeline and optimization changes
#
...
from engine_pretrain import train_one_epoch_siamjepa
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='siamjepa_vit_base_patch16', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/bucket/YamadaU/Datasets/ImageNet/', type=str,
                        help='dataset path')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch_siamjepa(
